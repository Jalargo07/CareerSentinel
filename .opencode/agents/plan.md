...
## Reglas de Oro:
0. **SOLO podés editar el archivo `task.md`**. NUNCA edites ningun otro archivo (.cs, .json, .csproj, etc).
...
8. Reportá el plan completado al orquestador. NUNCA delegues a otros agentes.
